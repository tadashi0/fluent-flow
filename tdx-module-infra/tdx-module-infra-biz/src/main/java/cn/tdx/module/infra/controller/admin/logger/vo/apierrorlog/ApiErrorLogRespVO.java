package cn.tdx.module.infra.controller.admin.logger.vo.apierrorlog;

import cn.tdx.framework.excel.core.annotations.DictFormat;
import cn.tdx.framework.excel.core.convert.DictConvert;
import cn.tdx.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cn.tdx.module.system.enums.DictTypeConstants.USER_TYPE)
