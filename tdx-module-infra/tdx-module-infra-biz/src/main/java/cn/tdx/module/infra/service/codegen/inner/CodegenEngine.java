package cn.tdx.module.infra.service.codegen.inner;

import cn.tdx.framework.tenant.core.db.TenantBaseDO;
...
import cn.tdx.framework.apilog.core.annotation.ApiAccessLog;
import cn.tdx.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.tdx.framework.common.util.date.DateUtils;
import cn.tdx.framework.common.util.date.LocalDateTimeUtils;
...
import cn.tdx.framework.excel.core.annotations.DictFormat;
import cn.tdx.framework.excel.core.convert.DictConvert;
import cn.tdx.framework.excel.core.util.ExcelUtils;
...
import cn.tdx.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "tdx-module-${table.moduleName}/" + // 顶级模块
                "tdx-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "tdx-module-${table.moduleName}/" + // 顶级模块
                "tdx-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "tdx-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "tdx-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
