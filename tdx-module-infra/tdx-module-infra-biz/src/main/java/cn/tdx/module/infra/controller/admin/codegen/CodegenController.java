package cn.tdx.module.infra.controller.admin.codegen;
...
import cn.tdx.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.tdx.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.tdx.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.tdx.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.tdx.module.infra.convert.codegen.CodegenConvert;
...
import cn.tdx.module.infra.service.codegen.CodegenService;
...
import static cn.tdx.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "tdx"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "嗒哒西")
    })
