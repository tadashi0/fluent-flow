package cn.tdx.framework.swagger.config;
...
import static cn.tdx.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class TdxSwaggerAutoConfiguration {
    ...
    private static Parameter buildSecurityHeaderParameter() {
        return new Parameter()
                ...
                .in(String.valueOf(SecurityScheme.In.HEADER)) // 请求 header
                .schema(new StringSchema()._default("Bearer-tdx test1").name(HEADER_TENANT_ID).description("认证 Token")); // 默认：使用用户编号为 1
    }
