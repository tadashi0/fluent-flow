package cn.tdx.framework.desensitize.core;

import cn.tdx.framework.common.util.json.JsonUtils;
import cn.tdx.framework.desensitize.core.annotation.Address;
import cn.tdx.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.tdx.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.tdx.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("安迈源码");
        ...
        desensitizeDemo.setRegex("你好，我是安迈源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("安迈源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "安迈源码", replacer = "*")
