...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("嗒哒西");
        ...
        desensitizeDemo.setRegex("你好，我是嗒哒西");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("嗒哒西");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "嗒哒西", replacer = "*")
