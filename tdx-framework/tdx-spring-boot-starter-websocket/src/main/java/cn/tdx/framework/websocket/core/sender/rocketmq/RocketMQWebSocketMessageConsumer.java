package cn.tdx.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${tdx.websocket.sender-rocketmq.topic}",
        consumerGroup = "${tdx.websocket.sender-rocketmq.consumer-group}",
