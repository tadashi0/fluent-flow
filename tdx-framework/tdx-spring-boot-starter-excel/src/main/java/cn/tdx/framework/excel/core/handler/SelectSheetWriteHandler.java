package cn.tdx.framework.excel.core.handler;

import cn.tdx.framework.common.core.KeyValue;
import cn.tdx.framework.dict.core.DictFrameworkUtils;
import cn.tdx.framework.excel.core.annotations.ExcelColumnSelect;
import cn.tdx.framework.excel.core.function.ExcelColumnSelectFunction;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
     ...
     */
    public static final int LAST_ROW = 5000;
    ...
    private static void setColumnSelect(WriteSheetHolder writeSheetHolder, Workbook workbook, DataValidationHelper helper,
        ...
        String refers = DICT_SHEET_NAME + keyValue.getKey() + "!$" + excelColumn + "$1:$" + excelColumn + "$" + keyValue.getValue().size();
