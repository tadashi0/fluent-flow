package cn.tdx.module.system.service.tenant;
...
import cn.tdx.framework.tenant.config.TenantProperties;
import cn.tdx.framework.tenant.core.context.TenantContextHolder;
import cn.tdx.framework.tenant.core.util.TenantUtils;
import cn.tdx.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import cn.tdx.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.tdx.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.tdx.module.system.convert.tenant.TenantConvert;
...
import cn.tdx.module.system.dal.mysql.tenant.TenantMapper;
import cn.tdx.module.system.enums.permission.RoleCodeEnum;
import cn.tdx.module.system.enums.permission.RoleTypeEnum;
...
import cn.tdx.module.system.service.tenant.handler.TenantInfoHandler;
import cn.tdx.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 tdx.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
