...
public interface AdminUserService {
     ...
     * @return 用户数组
     */
    List<AdminUserDO> getUserListByDeptIdsAndRoleIds(Collection<Long> deptIds, Collection<String> roles);
     ...
     * @return 用户数组
     */
    List<AdminUserDO> getUserListByRoleIds(Collection<String> roles);
