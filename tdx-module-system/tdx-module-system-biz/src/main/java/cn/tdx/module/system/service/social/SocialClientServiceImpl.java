package cn.tdx.module.system.service.social;
...
import cn.tdx.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.tdx.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.tdx.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.tdx.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.tdx.module.system.dal.dataobject.social.SocialClientDO;
import cn.tdx.module.system.dal.mysql.social.SocialClientMapper;
import cn.tdx.module.system.dal.redis.RedisKeyConstants;
import cn.tdx.module.system.enums.social.SocialTypeEnum;
...
import static cn.tdx.framework.common.util.collection.MapUtils.findAndThen;
import static cn.tdx.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${tdx.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${tdx.wxa-subscribe-message.miniprogram-state:formal}")
