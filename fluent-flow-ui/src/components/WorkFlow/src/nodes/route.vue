        ...
        <el-main>
          <el-form label-position="top">
            <div v-for="(routeNode, routeIndex) in form.routeNodes" :key="routeNode.nodeKey || routeIndex" class="route-branch-item">
              ...
              <el-button style="width: 100%" type="info" :icon="Plus" text bg @click="addConditionGroup(routeNode)">
                添加条件组
              </el-button>
            ...
            <el-button style="width: 100%; margin-top: 20px;" type="primary" :icon="Plus" @click="addRouteBranch">
              添加路由分支
            </el-button>
          </el-form>
        </el-main>
