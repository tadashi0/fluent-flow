<template>
  <div class="panel-tab__content">
    ...
    <!--      <el-table stripe :data="fieldList" max-height="240" fit border>-->
    ...
    <!--          >-->
    <!--        </p>-->
    <!--        <el-table stripe :data="fieldEnumList" key="enum-table" max-height="240" fit border>-->
    ...
    <!--        >-->
    <!--      </p>-->
    <!--      <el-table stripe :data="fieldConstraintsList" key="validation-table" max-height="240" fit border>-->
    <!--        <el-table-column label="序号" width="50px" type="index" />-->
    ...
    <!--        >-->
    <!--      </p>-->
    <!--      <el-table stripe :data="fieldPropertiesList" key="property-table" max-height="240" fit border>-->
    <!--        <el-table-column label="序号" width="50px" type="index" />-->
