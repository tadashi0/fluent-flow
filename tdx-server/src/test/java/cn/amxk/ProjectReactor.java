...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.tdx.boot";
    private static final String ARTIFACT_ID = "tdx";
    private static final String PACKAGE_NAME = "cn.tdx";
    private static final String TITLE = "嗒哒西产品管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.tdx.boot";
        String artifactIdNew = "tdx";
        String packageNameNew = "cn.tdx";
        String titleNew = "嗒哒西产品管理系统";
        String projectBaseDirNew = "/Users/tadashi/Workspace/tadashi/bak/fluent-flow"; // 一键改名后，“新”项目所在的目录
